...
public class WanAndroidBannerBean implements Serializable {

    public ObservableInt progressValue=new ObservableInt(0);//用来演示更新下载进度
...
//    private List<DataBean> data;  //这几个字段是每个接口公共的字段 已经放到ResultBean里了
