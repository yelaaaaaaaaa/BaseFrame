...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(final String packageName, final String className) {
        ...
        try {
            ...
            result = false;
            ALog.eTag(TAG, e, "isActivityExists");
        }
        return result;
    }
    ...
    public static boolean startHomeActivity() {
        try {
            ...
            ALog.eTag(TAG, e, "startHomeActivity");
        }
        return false;
    }
    ...
    public static String getLauncherActivity() {
        try {
            ...
            ALog.eTag(TAG, e, "getLauncherActivity");
        }
        return null;
    }
    ...
    public static Drawable getActivityIcon(final Class<?> clazz) {
        ...
        try {
            return getActivityIcon(new ComponentName(App.getInstance(), clazz));
        } catch (Exception e) {
            ALog.eTag(TAG, e, "getActivityIcon");
        }
        return null;
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clazz) {
        if (clazz == null) return null;
        try {
            return getActivityLogo(new ComponentName(App.getInstance(), clazz));
        } catch (Exception e) {
            ALog.eTag(TAG, e, "getActivityLogo");
        }
        return null;
    }
    ...
    public static String getActivityToLauncher(final String packageName) {
        ...
        try {
            ...
            ALog.eTag(TAG, e, "getActivityToLauncher");
        }
        return null;
    }
    ...
    public static ResolveInfo getLauncherCategoryHomeToResolveInfo() {
        try {
            ...
            ALog.eTag(TAG, e, "getLauncherCategoryHomeToResolveInfo");
        }
        return null;
    }
    ...
    public static Bundle getOptionsBundle(final Context context, final int enterAnim, final int exitAnim) {
        try {
            ...
            ALog.eTag(TAG, e, "getOptionsBundle");
        }
        return null;
    }
        ...
        if (activity != null) {
            synchronized (mActivityStacks) {
                ...
                try {
                    ...
                    ALog.eTag(TAG, e, "removeActivity");
                }
            }
        }
        return this;
    ...
    public ActivityUtils exitApplication() {
        try {
            ...
            ALog.eTag(TAG, e, "exitApplication");
            // =
            System.exit(-1);
        }
        return this;
    ...
    public ActivityUtils restartApplication() {
        try {
            ...
            ALog.eTag(TAG, e, "restartApplication");
        }
        return this;
    }
