...
public final class AppUtils {
    ...
    public static <T> T getSystemService(final String name) {
        ...
        try {
            return (T) App.getInstance().getSystemService(name);
        } catch (Exception e) {
    ...
    public static PackageManager getPackageManager() {
        try {
            ...
            ALog.eTag(TAG, e, "getPackageManager");
        }
        return null;
    }
    ...
    public static ApplicationInfo getApplicationInfo() {
        try {
            return App.getInstance().getApplicationInfo();
        } catch (Exception e) {
    ...
    public static ApplicationInfo getApplicationInfo(final String packageName, final int flags) {
        try {
            return App.getInstance().getPackageManager().getApplicationInfo(packageName, flags);
        } catch (Exception e) {
    ...
    public static PackageInfo getPackageInfo(final String packageName, final int flags) {
        try {
            return App.getInstance().getPackageManager().getPackageInfo(packageName, flags);
        } catch (Exception e) {
    ...
    public static SharedPreferences getSharedPreferences(final String fileName, final int mode) {
        try {
            return App.getInstance().getSharedPreferences(fileName, mode);
        } catch (Exception e) {
    ...
    public static boolean deleteDatabase(final String dbName) {
        try {
            return App.getInstance().deleteDatabase(dbName);
        } catch (Exception e) {
    ...
    public static String getAppSignatureHash(final String packageName, final String algorithm) {
        ...
        try {
            ...
            return StringUtil.colonSplit(ConvertUtils.toHexString(EncryptUtils.hashTemplate(signature[0].toByteArray(), algorithm)));
        } catch (Exception e) {
            ALog.eTag(TAG, e, "getAppSignatureHash - packageName: " + packageName + ", algorithm: " + algorithm);
            return null;
        }
    }
    ...
    public static boolean isInstalledApp2(final String packageName) {
        return !CommUtils.isEmpty(packageName) && IntentUtils.getLaunchAppIntent(packageName) != null;
    }
    ...
    public static boolean startActivity(final Intent intent) {
        ...
        try {
            App.getInstance().startActivity(IntentUtils.getIntent(intent, true));
            return true;
        } catch (Exception e) {
    ...
    public static boolean sendBroadcast(final Intent intent, final String receiverPermission) {
        ...
        try {
            App.getInstance().sendBroadcast(intent, receiverPermission);
            return true;
        } catch (Exception e) {
            ALog.eTag(TAG, e, "sendBroadcast");
        }
