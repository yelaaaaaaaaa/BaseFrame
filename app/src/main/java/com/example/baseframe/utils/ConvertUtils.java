...
public final class ConvertUtils {
    ...
    public static String toBinaryString(final byte... datas) {
        ...
        try {
            ...
            ALog.eTag(TAG, e, "toBinaryString");
        }
        return null;
    }
    ...
    public static byte[] decodeHex(final byte[] data) {
        return decodeHex((data.length == 0) ? null : bytesToChars(data));
    }
    ...
    public static byte[] decodeHex(final String str) {
        return decodeHex(TextUtils.isEmpty(str) ? null : str.toCharArray());
    }
    ...
    public static char[] toHexChars(final String str, final boolean toLowerCase) {
        return toHexChars(TextUtils.isEmpty(str) ? null : str.getBytes(), toLowerCase ? HEX_DIGITS : HEX_DIGITS_UPPER);
    }
    ...
    public static String toHexString(final String str, final boolean toLowerCase) {
        return toHexString(TextUtils.isEmpty(str) ? null : str.getBytes(), toLowerCase ? HEX_DIGITS : HEX_DIGITS_UPPER);
    }
