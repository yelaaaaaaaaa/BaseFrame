...
public final class ResourceUtils {
    ...
    public static AssetManager getAssets() {
        try {
            return App.getInstance().getAssets();
        } catch (Exception e) {
    ...
    public static ColorStateList getColorStateList(@ColorRes final int id) {
        try {
            return ContextCompat.getColorStateList(App.getInstance(), id);
        } catch (Exception e) {
    ...
    public static Bitmap getBitmap(final int resId) {
        try {
            return BitmapFactory.decodeResource(App.getInstance().getResources(), resId);
        } catch (Exception e) {
    ...
    public static boolean getBoolean(@BoolRes final int id) {
        try {
            return App.getInstance().getResources().getBoolean(id);
        } catch (Exception e) {
    ...
    public static XmlResourceParser getAnimation(@AnimatorRes @AnimRes final int id) {
        try {
            return App.getInstance().getResources().getAnimation(id);
        } catch (Exception e) {
    ...
    public static String getResourceName(@AnyRes final int id) {
        try {
            return App.getInstance().getResources().getResourceName(id);
        } catch (Exception e) {
    ...
    public static int[] getIntArray(@ArrayRes final int id) {
        try {
            return App.getInstance().getResources().getIntArray(id);
        } catch (Exception e) {
    ...
    public static CharSequence[] getTextArray(@ArrayRes final int id) {
        try {
            return App.getInstance().getResources().getTextArray(id);
        } catch (Exception e) {
    ...
    public static int getIdentifier(final String resName, final String defType, final String packageName) {
        try {
            return App.getInstance().getResources().getIdentifier(resName, defType, packageName);
        } catch (Exception e) {
    ...
    public static AssetFileDescriptor openFd(final String fileName) {
        try {
            return App.getInstance().getAssets().openFd(fileName);
        } catch (Exception e) {
    ...
    public static AssetFileDescriptor openNonAssetFd(final String fileName) {
        try {
            return App.getInstance().getAssets().openNonAssetFd(fileName);
        } catch (Exception e) {
    ...
    public static InputStream openRawResource(@RawRes final int id) {
        try {
            return App.getInstance().getResources().openRawResource(id);
        } catch (Exception e) {
    ...
    public static AssetFileDescriptor openRawResourceFd(@RawRes final int id) {
        try {
            return App.getInstance().getResources().openRawResourceFd(id);
        } catch (Exception e) {
