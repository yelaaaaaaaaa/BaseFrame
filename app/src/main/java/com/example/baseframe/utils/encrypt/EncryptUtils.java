package com.example.baseframe.utils.encrypt;

import com.blankj.ALog;
import com.example.baseframe.utils.ArrayUtils;
import com.example.baseframe.utils.CommUtils;
import com.example.baseframe.utils.ConvertUtils;
import com.example.baseframe.utils.cipher.Base64;
...
public final class EncryptUtils {
    ...
    public static byte[] encryptMD5File(final String filePath) {
        File file = CommUtils.isEmpty(filePath) ? null : new File(filePath);
    ...
    public static byte[] encryptMD5File(final File file) {
        ...
        try {
            ...
            ALog.eTag(TAG, e, "encryptMD5File");
            return null;
        } finally {
            if (dis != null) {
                try {
    ...
    public static byte[] symmetricTemplate(final byte[] data, final byte[] key, final String algorithm,
        ...
        try {
            ...
            ALog.eTag(TAG, e, "symmetricTemplate");
            return null;
        }
    }
