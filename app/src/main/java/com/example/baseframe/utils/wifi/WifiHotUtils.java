...
import com.example.baseframe.utils.CloseUtils;
...
//					wifiConfig.allowedProtocols.set(WifiConfiguration.Protocol.WPA);
            ...
            ALog.eTag(TAG, e, "createWifiConfigToAp");
        }
        return null;
    }
    ...
    public boolean stratWifiAp(final WifiConfiguration wifiConfig) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                mWifiManager.startLocalOnlyHotspot(new WifiManager.LocalOnlyHotspotCallback() {
                    ...
                    public void onStarted(WifiManager.LocalOnlyHotspotReservation reservation) {
                        ...
                        // 打印信息
                        ALog.dTag(TAG, "Android 8.0 onStarted wifiAp ssid: " + mAPWifiSSID + ", pwd: " + mAPWifiPwd);
                        // 触发回调
                    ...
                    public void onStopped() {
                        super.onStopped();
                        // 打印信息
                        ALog.dTag(TAG, "Android 8.0 onStopped wifiAp");
                        // 触发回调
                        if (mWifiAPListener != null) {
                    ...
                    public void onFailed(int reason) {
                        ...
                        // 打印信息
                        ALog.eTag(TAG, "Android 8.0 onFailed wifiAp, reason: " + reason);
                        // 触发回调
                        if (mWifiAPListener != null) {
            ...
            try {
                ...
                // 打印日志
                ALog.dTag(TAG, "设置 Wifi 热点信息是否成功: " + setResult);
                // 跳转到便携式热点设置页面
    ...
    public int getWifiApState() {
        try {
            ...
            // 打印状态
            ALog.dTag(TAG, "WifiApState: " + wifiApState);
            return wifiApState;
        } catch (Exception e) {
            ALog.eTag(TAG, e, "getWifiApState");
        }
    ...
    public WifiConfiguration getWifiApConfiguration() {
        try {
            ...
            ALog.eTag(TAG, e, "getWifiApConfiguration");
        }
        return null;
    }
    ...
    public boolean setWifiApConfiguration(final WifiConfiguration apWifiConfig) {
        try {
            ...
            ALog.eTag(TAG, e, "setWifiApConfiguration");
        }
        return false;
    }
    ...
    public String getHotspotServiceIp() {
        try {
            ...
            ALog.eTag(TAG, e, "getHotspotServiceIp");
        }
        return null;
    }
    ...
    public String getHotspotAllotIp() {
        try {
            ...
            ALog.eTag(TAG, e, "getHotspotAllotIp");
        }
        return null;
    }
...
//            }
//        } catch (Exception e) {
//            ALog.eTag(TAG, e, "getConnectHotspotMsg");
//        }
//        return null;
//    }
    ...
    public String getHotspotSplitIpMask(final String defaultGateway, final String ipAddress) {
        ...
        if (ipAddress != null) {
            try {
                ...
                ALog.eTag(TAG, e, "getHotspotSplitIpMask");
            }
        }
        return hsMask;
    }
