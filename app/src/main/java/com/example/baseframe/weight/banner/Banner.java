...
import com.example.baseframe.weight.banner.loader.ImageLoaderInterface;
import com.example.baseframe.weight.banner.loader.OnBannerListener;
import com.example.baseframe.weight.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.indicator_select);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.indicator_unselect);
    ...
    public Banner update(List<?> imageUrls, List<String> titles) {
        this.titles.clear();
